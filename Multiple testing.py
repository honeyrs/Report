...
# Ask for API ID, API hash, and user session at runtime
api_id = input(colored("Enter your Telegram API ID: ", "blue"))
api_hash = input(colored("Enter your Telegram API Hash: ", "blue"))
userstring_session = input(colored("Enter your user session file name (e.g., user_session): ", "blue"))
...
# Function to handle Single Report Mode
async def report_single(client):
    while True:
...
# Function to handle Multiple Report Mode
async def report_multiple(client):
    while True:
        print(colored("1: Account\n2: Channel\n3: Group\n4: Bot\n5: Post Link (Channel/Group Only)", "green"))
        report_type = get_valid_input("What you want to report: ", valid_options=[1, 2, 3, 4, 5])
        ...
        if report_type == 5:
            while True:
                ...
                try:
                    ...
                    print(colored("\nAll reports sentTelegram Report Modes
